...
fn convert_dto_to_layout(dto: LayoutSaveDto) -> Layout {
    ...
    Layout {
        ...
        show_base_layer_colors_for_unassigned_keys: dto.show_base_layer_colors_for_unassigned_keys,
...
pub(super) async fn get_layout(
    ...
    let layout_dto = LayoutDto {
        ...
        show_base_layer_colors_for_unassigned_keys: layout.show_base_layer_colors_for_unassigned_keys,
