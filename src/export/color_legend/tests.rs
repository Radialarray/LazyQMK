...
fn test_generate_color_legend_with_categories() {
    ...
    let delete_category = Category::new("delete", "Delete Keys", RgbColor::new(255, 0, 0)).unwrap();
...
fn test_generate_color_legend_with_colors() {
    ...
    let key = KeyDefinition::new(Position::new(0, 0), "KC_A").with_color(RgbColor::new(255, 0, 0));
    layer.add_key(key);
...
fn test_color_sources_individual_override() {
    ...
    let key1 = KeyDefinition::new(Position::new(0, 0), "KC_A").with_color(RgbColor::new(255, 0, 0));
    let key2 = KeyDefinition::new(Position::new(0, 1), "KC_B").with_color(RgbColor::new(255, 0, 0));
