...
pub struct CategoryPicker {
    ...
    /// Context - what is being categorized
    context: super::CategoryPickerContext,
}

impl CategoryPicker {
    /// Create a new CategoryPicker
    #[must_use]
    pub fn new(context: super::CategoryPickerContext) -> Self {
        Self {
    ...
    /// Get the picker context (what is being categorized)
    #[must_use]
    pub const fn get_context(&self) -> super::CategoryPickerContext {
        self.context
    }
...
/// Render the category picker dialog (legacy function for backward compatibility)
